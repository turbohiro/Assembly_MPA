from robosuite.robots.robot_me import RobotMe
import numpy as np


class ManipulatorMe(RobotMe):
    """
    ...
    def grip_action(self, robot, gripper_action):
        """
        ...
        """
        actuator_idxs = [self.sim.model.actuator_name2id(actuator) for actuator in robot.actuators]
        actuator_idxs = actuator_idxs[7:]
        gripper_action_actual = robot.format_action(gripper_action)
        ...
        #print('grip action is,',applied_gripper_action)
    ...
    def ee_force(self):
        ...
        return self.sim.data.sensordata[0:3]
