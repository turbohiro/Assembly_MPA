...
class ManipulatorModelMe(RobotModel):
    """
    ...
    def __init__(self, fname, idn=0):
        ...
        hand_element = find_elements(root=self.root, tags="body", attribs={"name": self.eef_name}, return_first=True)
        self.hand_rotation_offset = None
