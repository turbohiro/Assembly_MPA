...
class PegCircleObject(MujocoXMLObject):
    ...
    def __init__(self, name,seed_object):
        object_list =["objects/peg_circle.xml","objects/peg_ellipse.xml","objects/peg_triangle.xml","objects/peg_square.xml"]
        object_path = object_list[seed_object]
        super().__init__(
            xml_path_completion(object_path),
            name=name,
            joints=[dict(type="free", damping="0.0005")],
            obj_type="all",
            duplicate_collision_geoms=True,
